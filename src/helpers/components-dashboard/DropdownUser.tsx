...
import { logout } from "../redux-app/auth/_actions";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-red lg:text-base" onClick={()=>{dispatch(logout())}}>
